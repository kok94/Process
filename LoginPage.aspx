<%@ Page Language="C#" MasterPageFile="~/General.Master" AutoEventWireup="true" CodeBehind="LoginPage.aspx.cs" Inherits="WEBFINAL.LoginPage" %>
        ...
        <table style="width: 35%; height: 136px;margin-left:37%;margin-top:10%;text-align:left" >
            <tr>
                <td colspan="2" style="text-align: center" class="auto-style8">
                    <h6 class="auto-style2" style="margin-left:22%"> Staff Login Page</h6>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="auto-style3" style="margin-right:30%">
