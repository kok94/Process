<%@ Page Language="C#" MasterPageFile="~/General.Master" AutoEventWireup="true" CodeBehind="LoginPage(Customer).aspx.cs" Inherits="WEBFINAL.LoginPage_Customer_" %>
        ...
        <table style="width: 35%; height: 136px;margin-left:37%;margin-top:10%;text-align:left">
            <tr>
                <td colspan="2" style="text-align: center" class="auto-style3">
                    <h6 class="auto-style2" style="margin-left:20%"> Customer Login Page</h6>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="auto-style6" colspan="2">
                    <h3 style="text-align: center">
                        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Registration.aspx" style="font-size: small">Need a New Account ? Register Here</asp:HyperLink>
                    </h3>
                </td>
            </tr>
        </table>
