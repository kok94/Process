<%@ Page Language="C#" MasterPageFile="~/Driver.Master" AutoEventWireup="true" CodeBehind="DriverHomePage.aspx.cs" Inherits="WEBFINAL.DriverHomePage" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server"> 
    <div class="container_12">
			...
			<div class="c_phone">
				<div class="container_12">
					<div class="grid_12">
						<div class="fa fa-phone"></div>+ 03 9543 4896
						<span>ORDER NOW!</span>
					</div>
					<div class="clear"></div>
				</div>
